package com.coatardbul.base_server.service.impl;

import com.coatardbul.base_server.common.util.IdGeneratorSnowflake;
...
//        pool.shutdown();
        ...
        return  String.valueOf(idGeneratorSnowflake.snowflakeId());
    }
}
